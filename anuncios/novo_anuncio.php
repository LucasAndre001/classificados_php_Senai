...
//verifica se um ID foi passado pela URL(modo edição)
if (isset($_GET['id'])) {
      $modo_edicao = true;
      ...
      if ($resultado->num_rows === 1) {
            ...
            echo "<p class='erro'>Anúncio não encontrado ou você não tem permissão para editá-lo.</p>";
            include_once(__DIR__ . '/../foorte.php');
            exit();
      }
      $stmt->close();
}
...
<div class="form-wrapper">
      ...
      <!--Campo oculto para enviar o ID do anúncio-->
